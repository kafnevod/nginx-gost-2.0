...
- ALTLinux как и дистрибутивы   centos  ,  `redhat` использует пакеты   RPM , но командой установки пакетов является команда `apt-get`, а не `yum`;
...
- Копирование  `TGZ-архива` в `HOST-систему`;
