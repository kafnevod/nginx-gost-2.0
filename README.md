...
> Установка 4-й версии CSP-4 на севрера, отличные от сервера, на котором генерировался TGZ-архив в настроящее время не проверена. Так как сертиицированная версия CSP-4 при генерации ключа требует доступа к аппартным ресурсам, возможны проблемы при работа на других серверах. 
